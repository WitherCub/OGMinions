...
import me.wither.ogminions.extra.InvUtil;
import me.wither.ogminions.extra.ItemStackWrapper;
import me.wither.ogminions.extra.NumberUtil;
import me.wither.ogminions.extra.gui.IGuiClick;
...
public abstract class PageGui<T> extends RefreshGui implements IClickableGui {
    ...
    public void refresh() {
        ...
        for(int i = startIndex; i < startIndex+this.amountPerPage; i++) {
            ...
            if(realSlot == -1) {
                OGMinionsPlugin.get().log("Issue loading page; item listing slot is -1");
                break;
            }
