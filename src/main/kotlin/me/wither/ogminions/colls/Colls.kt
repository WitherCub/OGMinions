package me.wither.ogminions.colls

import com.massivecraft.massivecore.MassiveCore
import com.massivecraft.massivecore.store.Coll
import com.massivecraft.massivecore.store.SenderColl
import com.massivecraft.massivecore.util.MUtil
import me.wither.ogminions.Config
...
import me.wither.ogminions.extra.ItemStackWrapper
import org.bukkit.Color
import org.bukkit.Material

open class MPlayerColl: SenderColl<MPlayer>("ogminions_players") {
    companion object {
        @JvmStatic
...
class MinionColl: Coll<Minion>("ogminions_minionconf"){
    companion object {
        @JvmStatic
...
class ConfigColl: Coll<Config>("ogminions_config", Config::class.java, null, OGMinionsPlugin.get()) {
    companion object {
        @JvmStatic
