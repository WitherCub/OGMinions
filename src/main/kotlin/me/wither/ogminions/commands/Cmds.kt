package me.wither.ogminions.commands
...
import me.wither.ogminions.extra.ItemType
import me.wither.ogminions.extra.NBT
import me.wither.ogminions.extra.TxtUtil
import me.wither.ogminions.extra.Util
import me.wither.ogminions.gui.MinionShopGUI
...
open class CmdMinions: MinionCommand() {
    ...
    override fun getAliases(): MutableList<String> {
        return mutableListOf("minions", "ogminions")
    }
}
...
enum class Permission: Identified {
    ...
    private var id: String = PermissionUtil.createPermissionId(OGMinionsPlugin.get(), this)
